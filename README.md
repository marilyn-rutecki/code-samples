...
3. 04_generate_visualizations.py: Part of a larger data engineering project, where I used the original data visualizations and data sets from app.r, but housed data in AWS, then created a data pipeline with Snowflake and Databricks, and finally culminating in hosting data visualizations on a github website. This file simply shows the python code for the visualizations from data sources.

4. insight_code_mr1970.ipynb: Quick assignment for Data Science III class using unsupervised learning methods on energy burden data.
